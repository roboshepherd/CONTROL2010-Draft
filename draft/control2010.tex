...
D-Bus provides several language bindings for integrating D-Bus to any native application. The core D-BUS API, written in C, is rather low-level and large. Bindings integrate with programming languages and environments, e.g. Glib, Python, Qt and Mono. The preferred use of D-BUS is definitely using language and environment-specific bindings, both for ease of use and improved functionality \citep{Love2005}.
%===============================================================================
...
\begin{figure*}
\begin{center}
\includegraphics[width=11cm,height=6cm]{./dia-files/RIL-Expt-Setup3}    % The printed column width is 8.4 cm.
%\centering
